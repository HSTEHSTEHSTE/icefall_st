...
class Mambaformer(EncoderInterface):
    """
    Args:
    ...
    def __init__(
        ...
        self.encoder = MambaformerEncoder(d_model, num_encoder_layers)
...
class MambaformerEncoder(nn.Module):
    ...
    def __init__(self, encoder_layer_dim: int, num_layers: int) -> None:
        super().__init__()
...
if __name__ == "__main__":
    ...
    feature_dim = 50
    c = Mambaformer(num_features=feature_dim, d_model=128, nhead=4)
    batch_size = 5
    seq_len = 20
